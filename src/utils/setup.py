...
class Application:
    ...
    def __init__(self) -> None:
        ...
        self.screen = pygame.display.set_mode((Application.SCREEN_WIDTH, Application.SCREEN_HEIGHT))
        ...
        # font initialisation
        self.discCountFont = pygame.font.Font(pygame.font.get_default_font(), 40)
    ...
    def handleGameEnd(self, event: pygame.event.Event):
        ...
        # fade out the screen
        dummy_surface = pygame.Surface((Application.SCREEN_WIDTH, Application.SCREEN_HEIGHT))
    ...
    def switch_theme(self) -> None:
        ...
        # redisplay the last board position
        self.displayInitialBoardPos()
        self.shown_moves = False
        self.displayDiscs()
